...
//    Naravno u glavnom kreirati objekte i testirati funkcionalnosti
    ...
    public static void main(String[] args) {
        ...
        Racun posiljalac = new Racun("111-234567-66", "Milos Jovic", 500);
        Racun primalac = new Racun("567-55544-22", "Jovan Markovic", 500);
        Transakcija transakcija = new Transakcija("45676", posiljalac, primalac);

      transakcija.vrsenjeTransakcije(500);
      transakcija.print();
